...
$allowed_origins = ['http://localhost:3000', 'https://philippeducasse.com'];
...
if ($method === "POST") {
    try {
        ...
        $stmt = $db->prepare("INSERT INTO comments (name, show, message, date) VALUES (:name, :show, :message, :date)");
